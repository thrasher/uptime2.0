...
csv_file = "/var/log/uptime.csv"
try:
    f = open(csv_file, 'a+')
    if os.stat(csv_file).st_size == 0:
            f.write('Date,Time,Vin,Vout,Vbatt,TempC,TempF,Shutdown,Charging\r\n')
except:
    pass
...
#====================================================================================
	...
	f.write('{},{},{:.2f},{:.2f},{:.2f},{:.2f},{:.2f},{},{}\r\n'.format(time.strftime('%m/%d/%y'), time.strftime('%H:%M'), Vin, Vout, Vbattery, TempC, TempF, shutdown, charging))
